...
class ScreenAnalysis:
    ...
    # STAGING_URL = 'https://www.reddit.com/'
    # PRODUCTION_URL = 'https://www.reddit.com/r/AskReddit/'
    driver = None
    ...
    # def set_up(self):
    #     self.driver = webdriver.Firefox(executable_path="C:\\Users\\mauro\\Desktop\\Drivers/geckodriver.exe")
    ...
    def analyze(self):
        screenshot_staging = Image.open("screenshots/prueba1.png")
        screenshot_production = Image.open("screenshots/prueba2.png")
        columns = 60
        rows = 80
